...
<body>
        <div class="container">
            <h2 style="margin-top:6%; text-align:center">Ranking por Turma</h2><br>
            <p>
       ...
       if(isset($_POST['pesquisa']))
                  {
                    ...
                    if ($mysqli -> connect_errno) {
                      ...
                      exit();
                       ...
                       $sql = "SELECT * FROM user where turma ='$getvalor' and categoria = '$getvalor2' ORDER BY Points DESC";
                       $qtde = mysqli_query($conn, "SELECT count(*) as total FROM questions where turma ='$getvalor' and categoria = '$getvalor2' ORDER BY question DESC LIMIT 10");
