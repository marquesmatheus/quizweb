...
<body>
        <div class="container">
            <h2 style="margin-top:6%; text-align:center">Erros por Turma</h2><br>
            <p>
              <div>
            <?php 
              header("Content-type: text/html; charset=utf-8");
                include '../database/connection.php';
                  ...
                  $result = mysqli_query($conn, "select nome from turmas");
                  echo"<center>";
                   ...
                   $mysqli->set_charset("utf8");
                    ...
                    if ($mysqli -> connect_errno) {
                      ...
                      exit();
                       ...
                       $sql = "SELECT question,count(acertou) as Erros from history where acertou = 'Nao' and turma in ('$getvalor') and categoria = '$getvalor2' group by question order by erros desc";
                       $sql3 = "SELECT * FROM history where email ='$getvalor' and categoria = '$getvalor2' and answer <> '' order by acertou DESC";
                       $sql2 = mysqli_query($conn,"SELECT * FROM history where turma ='$getvalor' and categoria = '$getvalor2' and answer <> '' ");
    ...
    <?php   
              $i++;  
                ...
                echo "<div>";
                echo "<center><h4>Turma: ".$turmas['turma']."</h4><center>";
                echo "<center><h4>Categoria: ".$turmas['categoria']."</h4><center>";
                echo "</div>";
              }              
            }            
    ?>       
